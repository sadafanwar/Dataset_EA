#!/usr/bin/env python3
"""Fold 01 preflight for Ministral QLoRA with frozen EXP-06 oversampling."""
...
DEFAULT_CONFIG = REPO_ROOT / (
    "mistral_traceability/configs/config_mistral_8b_qlora_oversampling_fold_01.yaml"
)
...
def setup_logging(log_path: Path) -> logging.Logger:
    ...
    logger = logging.getLogger("mistral_8b_qlora_oversampling_preflight")
...
def main() -> int:
    ...
    try:
        ...
        logger.exception("Ministral QLoRA oversampling preflight failed")
    finally:
