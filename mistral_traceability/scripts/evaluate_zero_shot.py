#!/usr/bin/env python3
"""
Evaluate Ministral-3-8B-Instruct-2512-BF16 without task-specific fine-tuning on the same 10 held-out test folds.
...
def create_summary(output_base: Path):
    ...
    output = {
        "experiment": "M-E1: Ministral-3-8B-Instruct-2512-BF16, zero-shot, no task-specific fine-tuning, evaluated on the same 10 frozen held-out test folds",
        "folds": rows,
        "summary": summary,
    ...
    json_path = output_base / "m_e1_zero_shot_summary.json"
    csv_path = output_base / "m_e1_zero_shot_summary.csv"
...
def main():
    ...
    parser.add_argument("--model_path", default="mistralai/Ministral-3-8B-Instruct-2512-BF16")
    parser.add_argument("--start_fold", type=int, default=1)
    parser.add_argument("--end_fold", type=int, default=10)
    parser.add_argument("--max_new_tokens", type=int, default=5)
    parser.add_argument("--max_length", type=int, default=1024)
    parser.add_argument("--output_dir", default="mistral_traceability/results/m_e1_zero_shot")
    args = parser.parse_args()

    data_base = Path("mistral_traceability/data")
