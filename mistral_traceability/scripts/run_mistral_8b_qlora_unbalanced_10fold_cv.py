...
DEFAULT_CONFIG = REPO_ROOT / (
    "mistral_traceability/configs/config_mistral_8b_qlora_unbalanced_10fold.yaml"
)
...
def setup_logging(log_path: Path) -> logging.Logger:
    ...
    logger = logging.getLogger("mistral_8b_qlora_unbalanced_10fold")
...
def create_summary(config: dict[str, Any]) -> None:
    ...
    json_path = result_root / "mistral_8b_qlora_unbalanced_10fold_summary.json"
    csv_path = result_root / "mistral_8b_qlora_unbalanced_10fold_summary.csv"
