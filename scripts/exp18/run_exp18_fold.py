#!/usr/bin/env python3
"""Controlled per-fold runner and tracker for EXP-18."""
...
def main() -> int:
    ...
    print()
    print("=" * 70)
    print("EXP-18 CONTROLLED FOLD RUNNER")
    print("=" * 70)
    ...
    try:
        ...
        print()
        print("=" * 70)
        print("EXP-18 FOLD TRAINING COMPLETED")
        print(f"Fold   : {fold_name}")
        print(
